...
public class AdminCategoryController {
    ...
    @PatchMapping("/{id}/status") public Object status(@PathVariable long id,@Valid @RequestBody com.shop.dto.CatalogDtos.StatusWrite body){return service.status(id,body.isActive());}
}
